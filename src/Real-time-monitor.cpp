...
void CallDetectionEngine(const char* filePath) {
	...
	char command[1024];
	sprintf(command, "C:/Users/ADMIN/Desktop/MetaDenfender_Logic/x64/Debug/MetaDenfender_Logic.exe \"%s\"", filePath);
...
DWORD MonitorDirectoryThread(LPVOID lpParameter) {

	PCSTR directoryPath = reinterpret_cast<LPCSTR>(lpParameter);
...
int main(int argc, char* argv[]) {
	...
	//for debugging
	char pathList[] = "C:\\Users\\ADMIN\\Desktop;";
